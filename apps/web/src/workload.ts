...
export const defaultWorkloadForm: WorkloadFormState = {
  ...
  databaseSearchNodeHours: String(HOURS_PER_MONTH),
  ...
  appPlatformAlwaysOnHours: String(HOURS_PER_MONTH),
...
export const ARCHITECTURE_TEMPLATES: ArchitectureTemplate[] = [
  ...
  },
  {
    ...
    form: templateForm({
      ...
      aiModelHostingHours: String(HOURS_PER_MONTH),
...
function runtimeScaleParamsFromForm(form: WorkloadFormState): ServiceRequirement['scaleParams'] {
  return {
    ...
    kubernetesWorkerVcpu: parsePositiveNumber(form.vcpu, 2),
    kubernetesWorkerMemoryGb: parsePositiveNumber(form.memoryGb, 4),
