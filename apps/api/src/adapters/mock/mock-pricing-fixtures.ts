...
const PROVIDER_SHAPES: Record<ProviderId, MockProviderShape> = {
  ...
  azure: {
    ...
    compute: [
      ...
      {
        sku: 'Standard_B2ms',
        name: 'Azure B2ms Burstable',
        family: 'burstable',
        vcpu: 2,
        memoryGb: 8,
        hourlyUsd: 0.0416,
        processorArchitecture: 'x86_64',
        networkBaseline: 'burstable shared-core bandwidth',
        diskBaseline: 'Premium SSD capable burst baseline',
      },
      {
        sku: 'Standard_F4s_v2',
        name: 'Azure F4s v2',
  ...
  gcp: {
    ...
    compute: [
      ...
      {
        sku: 'e2-small',
        name: 'Compute Engine E2 Small Shared-Core',
        family: 'burstable',
        vcpu: 2,
        memoryGb: 2,
        hourlyUsd: 0.0168,
        processorArchitecture: 'x86_64',
        networkBaseline: 'shared-core burst baseline',
        diskBaseline: 'Persistent Disk balanced baseline',
      },
      {
        sku: 'c3-standard-4',
