...
> _"Follow `cpn-design-system.md`. Colors in §2 are non-negotiable brand tokens. You may improve layout/UX/components, but every color must resolve to a token defined here — no new hex values."_
...
4. **PAM AI button** (AI assistant entry): `h-10 px-4 rounded-btn border border-line bg-surface-card text-brand-500 font-medium flex items-center gap-2` with sparkle icon — _outlined-white with brand text_, deliberately not a filled button.
...
1. **Step 0 reality-check:** inventory the existing screens; classify each element as _conforms / off-token / missing_ before writing code. Never assume a component exists.
...
<div class="min-h-screen bg-surface-canvas font-sans">
  ...
  <aside class="fixed inset-y-0 left-0 w-60 bg-brand-500 text-white flex flex-col">
    ...
    <nav class="px-3 pt-6 space-y-1 text-[15px]">
      ...
      <a class="flex items-center gap-3 h-11 px-3 rounded-btn text-white/90 hover:bg-white/10"
        >Content</a
      >
      <a class="flex items-center gap-3 h-11 px-3 rounded-btn text-white/90 hover:bg-white/10"
        >Flows</a
  ...
  <div class="ml-60">
    ...
    <header class="h-16 bg-surface-card border-b border-line flex items-center gap-4 px-6">
      ...
      <input
        class="w-60 h-10 rounded-btn border border-line pl-9 text-sm placeholder:text-ink-400"
        placeholder="Search"
      />
      <button class="h-10 px-4 rounded-btn border border-line text-brand-500 font-medium">
        ✦ PAM AI
      </button>
    ...
    <div class="h-12 bg-brand-500 text-white flex items-center gap-3 px-6">
      ...
      <div class="flex-1"></div>
      <button class="h-8 px-4 rounded-btn bg-white text-ink-900 text-sm font-medium shadow-sm">
        View Flow
      </button>
    ...
    <main class="px-10 pt-10">
      <h1 class="text-[28px] font-semibold text-ink-900 tracking-tight">
        Welcome back, TKXEL (Partner)!
      </h1>
      <p class="text-sm text-ink-600 mt-1">
        Everything you need is accessible and manageable through your personal portal.
      </p>
        ...
        <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3 mt-5">
          ...
          <div class="border border-line rounded-card overflow-hidden">
            ...
            <div class="p-4 pt-3">
              ...
              <button class="mt-4 text-sm font-medium text-brand-500 hover:text-brand-600">
                Open content
              </button>
            </div>
          </div>
          ...
          <div class="border border-brand-500 rounded-card overflow-hidden bg-brand-50">
            <div class="h-8 bg-brand-100 relative">
              <span
                class="absolute left-3 -bottom-2 w-6 h-6 bg-brand-500 text-white rounded-md grid place-items-center text-xs"
                >◆</span
              >
            </div>
            <div class="p-4 pt-4">
              ...
              <button
                class="mt-4 h-10 px-4 rounded-btn bg-brand-500 hover:bg-brand-600 text-white text-sm font-medium"
              >
                Open flow
              </button>
            </div>
...
_End of spec. Any question this file doesn't answer should be resolved in favor of: neutral surface, terracotta accent, 1px border, 8–10px radius, no shadow._
